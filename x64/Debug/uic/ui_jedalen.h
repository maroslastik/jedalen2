...
public:
    ...
    void setupUi(QMainWindow *jedalenClass)
    {
        ...
        doubleSpinBox = new QDoubleSpinBox(udaje_uzi);
        ...
        horizontalLayout_2->addWidget(den);
